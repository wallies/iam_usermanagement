'use strict';
  ...
  var apiAuthUrl = 'https://sso.testserver.com/oneid/identity/json/authenticate',
    _authenticated = false,
    _username = null

  angular
    .module('AuthApp', ['http-auth-interceptor', 'authentication', 'ngMockE2E'])
    ...
    .run(['$httpBackend', function ($httpBackend) {
      ...
      $httpBackend.whenPOST(apiAuthUrl).respond(function (method, url, data) {
        ...
        if (data.username && data.password) {
          ...
          return [200, {username: _username, success: true}];
        }
